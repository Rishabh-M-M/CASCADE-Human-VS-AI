...
((!!! NOTES: ADD LINKS TO PAGES HERE as well))

- **VERSUS** — landing
- **HUMAN** — the human perspective behind building Cascade
- **AI** — the agent, how it works, the inspiration, the dev journey and what it achieved
- **END** — reflection
- **CONTACT** — get in touch

## Tech Stack
((!!! NOTES: ADD FINAL ONES AFTER COMPLETION))
- Vite + React
- Tailwind CSS
- Framer Motion
- GSAP
